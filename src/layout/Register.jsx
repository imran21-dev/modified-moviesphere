...
const Register = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Register | MovieSphere</title>
      </Helmet>
      {loading.state === "loading" ? (
        ...
        <div className="py-96 md:py-20 h-screen flex flex-col justify-center">
          <section className="md:w-4/12 w-9/12 mx-auto">
            <h1 className="text-xl md:text-3xl pb-2 font-semibold">Create Your Account</h1>
            <p className="md:pb-8 pb-3 text-xs md:text-sm text-neutral/40">
              Step into a world of unlimited entertainment!
            </p>
            <form onSubmit={handleForm} className="w-full text-xs md:text-sm relative ">
              <div className="form-control pb-1">
                <label className="label">
                  <span className="label-text md:text-sm text-xs">Name</span>
                </label>
              ...
              <div className="form-control pb-1">
                <label className="label">
                  <span className="label-text md:text-sm text-xs">Photo URL</span>
                </label>
                <div className="flex items-center w-full  border rounded-full -ml-1 border-secondary">
              ...
              <div className="form-control pb-1">
                ...
                <div className="flex items-center w-full  border rounded-full -ml-1 border-secondary">
                  ...
                  {showHide ? (
                    <VscEye
                      onClick={showPass}
                      className="mx-3 cursor-pointer text-lg"
                    />
                  ) : (
                    <VscEyeClosed
                      onClick={showPass}
                ...
                {passValid ? (
                  ...
                  <span className="text-accent/90 text-left text-[10px] md:text-xs pt-1">
                    Password must be at least one Uppercase, one Lowercase and
                    minimum 6 character.
                  </span>
                )}
              </div>
            ...
            <div className="mx-auto w-max md:pt-4">
              <button
                onClick={openPopup}
